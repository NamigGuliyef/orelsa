...
import {
  createBrowseRangeDto,
  createNewCollectionDto,
  updateBrowseRangeDto,
  updateNewCollectiontDto,
} from '../home_page/dto/home.dto';
import {
  HomeBrowseRange,
  HomeNewCollection,
...
export class AdminController {
  ...
  @ApiOperation({
    summary: 'Home səhifəsində new collection hissəsinin yaradılması',
  })
  ...
  async createNewCollection(
    ...
    return await this.adminService.createNewCollection(
      CreateNewCollectionDto,
      photo,
    );
  }
  ...
  @ApiOperation({
    summary: 'Home səhifəsində new collection hissəsində dəyişiklik',
  })
  @ApiConsumes('multipart/form-data')
  @ApiBody({
    schema: {
  ...
  @UsePipes(new ValidationPipe())
  @UseInterceptors(FileInterceptor('photo', MulterOptions))
  async updateNewCollection(
    @Param('_id') _id: string,
    @Body() UpdateNewCollectiontDto: updateNewCollectiontDto,
    @UploadedFile() photo: Express.Multer.File,
  ): Promise<MessageResponse> {
    return await this.adminService.updateNewCollection(
      _id,
      UpdateNewCollectiontDto,
      photo,
    );
  ...
  @ApiOperation({
    summary: 'Home səhifəsində new collection hissəsində data silmək',
  })
  @Delete('/dashboard/homeNewCollection/:_id')
  @HttpCode(HttpStatus.OK)
  async deleteNewCollection(
    @Param('_id') _id: string,
  ): Promise<MessageResponse> {
  ...
  @ApiOperation({
    summary: 'Home səhifəsində new collection hissəsində datalara baxış',
  })
  ...
  @HttpCode(HttpStatus.OK)
  async getSingleNewCollection(
    @Param('_id') _id: string,
  ): Promise<HomeNewCollection> {
  ...
  @UsePipes(new ValidationPipe())
  @UseInterceptors(FileInterceptor('photo', MulterOptions))
  async createBrowseRange(
    @Body() CreateBrowseRangeDto: createBrowseRangeDto,
    @UploadedFile() photo: Express.Multer.File,
  ): Promise<MessageResponse> {
    return await this.adminService.createBrowseRange(
      CreateBrowseRangeDto,
      photo,
    );
  }
  ...
  @ApiOperation({
    summary: 'Home page - seçilmiş kateqoriyalar bölməsində dəyişiklik',
  })
  @ApiConsumes('multipart/form-data')
  @ApiBody({
    schema: {
  ...
  @UsePipes(new ValidationPipe())
  @UseInterceptors(FileInterceptor('photo', MulterOptions))
  async updateBrowseRange(
    @Param('_id') _id: string,
    @Body() UpdateBrowseRangeDto: updateBrowseRangeDto,
    @UploadedFile() photo: Express.Multer.File,
  ): Promise<MessageResponse> {
    return await this.adminService.updateBrowseRange(
      _id,
      UpdateBrowseRangeDto,
      photo,
    );
  ...
  @ApiOperation({
    summary: 'Home page - seçilmiş kateqoriyalar bölməsin silmək',
  })
  ...
  @ApiOperation({
    summary: 'Home page - seçilmiş kateqoriyalar bölməsində datalara baxış',
  })
  ...
  @HttpCode(HttpStatus.OK)
  async getSingleBrowseRange(
    @Param('_id') _id: string,
  ): Promise<HomeBrowseRange> {
    ...
    schema: {
      ...
      properties: {
        ...
        new: {
          type: 'boolean',
          description:
            'Məhsulun yeni və ya köhnə olmasını göstərir (default false gəlir)',
        },
        photos: { type: 'array', items: { type: 'string', format: 'binary' } },
        active: {
          type: 'boolean',
          description:
            'Məhsulun aktiv olub - olmasını göstərir (default false gəlir)',
        },
      },
    },
  })
  ...
  async updateProduct(
    ...
    return await this.adminService.updateProduct(_id, UpdateProduct, []);
  }
